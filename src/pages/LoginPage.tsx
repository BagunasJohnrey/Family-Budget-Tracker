    ...
    <div className="h-full flex flex-col items-center justify-center bg-gradient-to-br from-teal-600 to-cyan-700 dark:from-teal-900 dark:to-cyan-950 p-4">
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-white tracking-tight">Family Budget Tracker</h1>
          <p className="text-teal-100/70 text-sm mt-1">Sign in to manage your finances</p>
        </div>
